...
static void workingset_collector_fill_record_filenode_wsrcrdlocked(
	...
	struct s_ws_record *record, bool is_exist)
{
	...
	workingset_collector_fill_record_filenode_wsrcrdlocked(data,
		&ws->file_list);
...
static void workingset_preread_post_work_rcrdlocked(struct s_ws_record *record, struct file **filpp)
{
