 ...
 */
#ifndef _GC5025_HOLI_SENSOR_H
#define _GC5025_HOLI_SENSOR_H
...
static imgsensor_info_t imgsensor_info = {
	.sensor_id_reg = 0xf0,
	.sensor_id = GC5025_HOLI_SENSOR_ID,	//Sensor ID Value: 0x8044//record sensor id defined in Kd_imgsensor.h
