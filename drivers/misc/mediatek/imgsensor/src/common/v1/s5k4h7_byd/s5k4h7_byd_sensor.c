...
#include "s5k4h7_byd_sensor.h"

#define RETRY_TIMES 2

/****************************Modify Following Strings for Debug****************************/
#define PFX "[s5k4h7_byd]"
#define DEBUG_S5K4H7_BYD 0
#define LOG_DBG(fmt, args...)    if (DEBUG_S5K4H7_BYD) pr_debug(PFX "%s %d " fmt, __func__,__LINE__, ##args)
...
static kal_uint32 feature_control_s5k4h7_byd(MSDK_SENSOR_FEATURE_ENUM feature_id,
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	get_info,
	get_resolution,
	feature_control_s5k4h7_byd,
	control,
	close
};


UINT32 S5K4H7_BYD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
