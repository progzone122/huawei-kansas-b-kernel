...
#ifndef _OV13855_OFILM_SENSOR_H
#define _OV13855_OFILM_SENSOR_H
...
#define NORMAL_EXPOSE_TIME_MAX			300000  //us
...
static struct imgsensor_i2c_reg init_setting[] = {
	...
	{0x3822, 0xc2, 0x00},
	{0x3823, 0x18, 0x00},
	{0x3824, 0x00, 0x00}, // 20180913
	{0x3825, 0x00, 0x00}, // 20180913
	{0x3826, 0x00, 0x00}, //  11 20180913
	{0x3827, 0x00, 0x00}, //  1c 20180913
	{0x3829, 0x00, 0x00}, // 03
	{0x3832, 0x00, 0x00},
	{0x3c80, 0x00, 0x00},
	{0x3c87, 0x01, 0x00},
...
imgsensor_i2c_reg_setting_t normal_to_long_ready_settings = {
...
imgsensor_i2c_reg_setting_t normal_to_long_end_settings = {
...
static imgsensor_info_t imgsensor_info = {
	...
	.sensor_id = OV13855_OFILM_SENSOR_ID,      //Sensor ID Value: 0xD855//record sensor id defined in Kd_imgsensor.h
	...
	.pre = {
		...
		.framelength = 3176,            //record different mode's framelength
	...
	.cap = {
		.pclk = 108000000,              //record different mode's pclk
		.linelength  = 1122,            //record different mode's linelength
		.framelength = 3192,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
