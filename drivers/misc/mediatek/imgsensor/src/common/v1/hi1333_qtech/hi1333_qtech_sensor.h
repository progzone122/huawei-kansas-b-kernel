...
static imgsensor_info_t imgsensor_info = {
	...
	.checksum_value = 0xabaa55c3,       // Auto Test Mode
	.pre = {
		.pclk = 584000000,              //record different mode's pclk
		.linelength =  5952,            //record different mode's linelength
		.framelength = 3238,            //record different mode's framelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	{4208, 3120, 0,   0, 4208, 3120,	2104, 1562,  0, 0, 2104, 1560, 0, 0, 2104, 1560},	// preview (2104 x 1560)
	{4208, 3120, 0,   0, 4208, 3120,	4208, 3120,  0, 0, 4208, 3120, 0, 0, 4208, 3120},	// capture (4208 x 3120)
	{4208, 3120, 0,   0, 4208, 3120,	4208, 3120,  0, 0, 4208, 3120, 0, 0, 4208, 3120},	// VIDEO (4208 x 3120)
};
